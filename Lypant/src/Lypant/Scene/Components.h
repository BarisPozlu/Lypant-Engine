...
namespace lypant
{
	...
	{
	public:
		MeshComponent(const std::shared_ptr<Buffer>& vertexBuffer, const std::shared_ptr<Buffer>& indexBuffer, const std::shared_ptr<Material>& material)
			: MeshData(vertexBuffer, indexBuffer, material)
		{
		}
